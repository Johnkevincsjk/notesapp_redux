    ...
    return (
        <div className='d-flex flex-row h-100'>
            ...
            <div className='card m-1 text-center' style={{ width: "15rem", height: "12rem" }}>
                {isEdit && isid === id ? (
                    <>
                        <input className='update_input' type="text" required onChange={(e) => setEditTitle(e.target.value)} placeholder='Title' />
                        <input className='update_input' type="text" required onChange={(e) => setEditContent(e.target.value)} placeholder='Content' />
                    ...
                    <div className="card-body">
                        <div className='card-header d-flex p-1 align-content-center justify-content-between'>
                            ...
                            <div className='d-flex align-content-center'>
                                ...
                                <button className="delete_btn ms-2" onClick={() => dispatch(deletePost(id))} >
                                    <MdDelete />
                                </button>
                            </div>
                        </div>
